    ...
    <div ref={ref} className='p-7! max-w-275 m-auto! lg:my-18!'>
      ...
      <div className='p-1! grid grid-cols-2 lg:grid-cols-4 justify-items-center gap-5 mt-10!'>
        {Object.values(technologies).map((tech) => {
          return (
            <div
              className='transition-transform duration-300 hover:scale-70 hover:rounded-full h-25 w-25 sm:h-40 sm:w-40 lg:p-8! p-5! flex items-center justify-center lg:rounded-4xl rounded-2xl bg-[#a6a6a644]  shadow-[0_10px_30px_rgba(0,0,0,0.9), 0_0_15px_rgba(59,130,246,0.9), 0_0_30px_rgba(59,130,246,0.9)]' key={tech.name}>
